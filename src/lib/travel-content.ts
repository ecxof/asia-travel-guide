...
export const destinations: Destination[] = [
  {
    ...
    whyChineseTravelers: [
      {
        en: "Popular for anniversaries, proposals, and Golden Week luxury escapes.",
        zh: "非常适合纪念日、求婚和黄金周高品质度假。",
      },
      {
        en: "Many resorts already understand Chinese dining preferences and celebration packages.",
        zh: "不少度假村对中国旅客的餐饮偏好和庆祝场景更熟悉。",
      },
      {
        en: "Low-pressure planning once airport transfer and resort package are set.",
        zh: "选好接送和度假村套餐后，整体规划压力很低。",
      },
    ],
    topPlaces: [
      {
        en: "North Malé Atoll for classic luxury resorts and convenient speedboat transfers",
        zh: "北马累环礁：经典奢华度假村和便捷快艇接送",
      },
      {
        en: "Baa Atoll for manta ray season and quieter marine experiences",
        zh: "芭环礁：蝠鲼季和更静谧的海洋体验",
      },
      {
        en: "South Ari Atoll for whale shark excursions and strong snorkeling",
        zh: "南阿里环礁：鲸鲨出海与优质浮潜",
      },
    ],
    bestTime: [
      {
        en: "December to April for dry weather and postcard skies",
        zh: "12 月到次年 4 月：天气稳定，景观最梦幻",
      },
      {
        en: "November for a softer price-to-weather balance before peak crowds",
        zh: "11 月：价格与天气表现更平衡，旺季前更从容",
      },
    ],
    practicalTips: [
      {
        en: "Compare full-board and half-board resort pricing before booking flights.",
        zh: "订机票前先比较含餐套餐，整体预算差异很大。",
      },
      {
        en: "Seaplane transfer timing can shape your first and last day more than expected.",
        zh: "水上飞机接驳时间会明显影响到达日和离开日安排。",
      },
      {
        en: "Bring lightweight sun gear and underwater-friendly phone protection.",
        zh: "记得带轻便防晒装备和适合下水的手机防护。",
      },
    ],
  },
  {
    ...
    bestFor: {
      en: "Luxury shopping, city breaks, family comfort",
      zh: "购物、城市短假、家庭舒适出行",
    },
    tagline: {
    ...
    whyChineseTravelers: [
      {
        en: "Mandarin service is increasingly common in premium hotels and retail environments.",
        zh: "高端酒店和零售场景中，中文服务越来越常见。",
      },
      {
        en: "Shopping, desert experiences, and landmark architecture work well for couples and families alike.",
        zh: "购物、沙漠体验和地标建筑适合情侣也适合家庭同行。",
      },
      {
        en: "A strong option for winter sunshine when East Asia weather feels dull or cold.",
        zh: "当东亚进入阴冷季节时，是很好的冬日阳光选择。",
      },
    ],
    topPlaces: [
      {
        en: "Downtown Dubai for Burj Khalifa, Dubai Mall, and dramatic skyline energy",
        zh: "迪拜市中心：哈利法塔、Dubai Mall 与标志性天际线",
      },
      {
        en: "Palm Jumeirah for beachfront resort stays and polished nightlife",
        zh: "朱美拉棕榈岛：海滨度假与精致夜生活",
      },
      {
        en: "Abu Dhabi Cultural District for Louvre Abu Dhabi and architectural icons",
        zh: "阿布扎比文化区：卢浮宫阿布扎比与地标建筑",
      },
    ],
    bestTime: [
      {
        en: "November to March for the most comfortable outdoor weather",
        zh: "11 月到次年 3 月：最适合户外活动",
      },
      {
        en: "January for shopping festival energy and cooler city touring",
        zh: "1 月：购物节氛围更强，城市观光舒适",
      },
    ],
    practicalTips: [
      {
        en: "Reserve headline attractions early if you travel during Chinese holidays.",
        zh: "如果在中国假期出行，热门项目建议提前预约。",
      },
      {
        en: "Taxi and ride-hailing are often simpler than self-driving for short stays.",
        zh: "短途停留时，打车和网约车通常比自驾更省心。",
      },
      {
        en: "Plan indoor attractions for midday when desert heat rises outside winter months.",
        zh: "非冬季中午更适合安排室内项目，避开高温时段。",
      },
    ],
  },
  {
    ...
    bestFor: {
      en: "Mountains, fresh air, and value-driven adventure",
      zh: "高山风景、自然空气、性价比探索",
    },
    tagline: {
    ...
    whyChineseTravelers: [
      {
        en: "Direct flight options and border familiarity make it approachable for short holidays.",
        zh: "直飞航线和地缘熟悉感让它适合短假出行。",
      },
      {
        en: "Costs stay more manageable than many beach luxury destinations.",
        zh: "整体成本通常比海岛轻奢目的地更可控。",
      },
      {
        en: "A good answer when you want scenery, hiking, and cafés rather than malls or resorts.",
        zh: "如果你更想要风景、徒步和咖啡馆，而不是商场或海岛，它会很对味。",
      },
    ],
    topPlaces: [
      {
        en: "Almaty for leafy city life, cafés, and a strong base for day trips",
        zh: "阿拉木图：城市气质舒适，也是周边游的最佳基地",
      },
      {
        en: "Big Almaty Lake for dramatic blue water and mountain framing",
        zh: "大阿拉木图湖：湖水颜色惊艳，山景层次分明",
      },
      {
        en: "Charyn Canyon for a more cinematic desert-and-rock contrast",
        zh: "恰伦峡谷：更具大片感的峡谷与岩层景观",
      },
    ],
    bestTime: [
      {
        en: "May to June for green landscapes and comfortable temperatures",
        zh: "5 到 6 月：草木最美，温度舒适",
      },
      {
        en: "September for crisp air, fewer crowds, and stable sightseeing weather",
        zh: "9 月：空气清爽，人流更轻，适合观景",
      },
    ],
    practicalTips: [
      {
        en: "Layer clothing because mountain weather changes quickly across one day.",
        zh: "山区天气变化快，穿搭建议分层。",
      },
      {
        en: "Use Almaty as the anchor and keep longer drives for one or two headline days.",
        zh: "建议以阿拉木图为核心，把长途车程留给一到两个重点日程。",
      },
      {
        en: "Cashless payment is improving, but keep a backup card and some cash outside urban centers.",
        zh: "无现金支付越来越方便，但离开城市后最好备少量现金和备用卡。",
      },
    ],
  },
  {
    ...
    visaStay: { en: "Visa free entry · 30 days", zh: "免签入境 · 30 天" },
    flightTime: {
      en: "About 6 to 8 hours depending on city pair",
      zh: "按出发城市不同约 6 到 8 小时",
    },
    ...
    whyChineseTravelers: [
      {
        en: "Strong storytelling value for travelers who like history, museums, and meaningful photography.",
        zh: "对于喜欢历史、博物馆和旅行影像的人，这里有很强的内容感。",
      },
      {
        en: "Costs are comparatively friendly while the sense of uniqueness stays very high.",
        zh: "相对友好的预算，换来很高的独特性。",
      },
      {
        en: "A compelling alternative when mainstream beach destinations feel too familiar.",
        zh: "如果海岛和都市目的地已经看得太多，它会带来明显新鲜感。",
      },
    ],
    topPlaces: [
      {
        en: "Samarkand for Registan Square and the most iconic blue-tile scenery",
        zh: "撒马尔罕：雷吉斯坦广场和最经典的蓝砖建筑",
      },
      {
        en: "Bukhara for atmospheric old-city streets and heritage depth",
        zh: "布哈拉：老城街巷氛围与深厚历史层次",
      },
      {
        en: "Tashkent for a softer arrival with metro design and modern comforts",
        zh: "塔什干：更轻松的落地体验与现代城市配套",
      },
    ],
    bestTime: [
      {
        en: "April to May for mild weather and vivid city walks",
        zh: "4 到 5 月：天气温和，适合徒步观城",
      },
      {
        en: "September to October for golden light and comfortable cultural touring",
        zh: "9 到 10 月：光线漂亮，适合文化观光",
      },
    ],
    practicalTips: [
      {
        en: "Split nights between Samarkand and Bukhara instead of rushing both as day trips.",
        zh: "建议在撒马尔罕和布哈拉分别住一晚，不要都做成赶路式一日游。",
      },
      {
        en: "Morning and late afternoon light make the architecture look dramatically better for photos.",
        zh: "如果想拍好建筑，清晨和傍晚的光线会好很多。",
      },
      {
        en: "Comfortable walking shoes matter because old-city sightseeing is more on-foot than expected.",
        zh: "老城观光步行为主，鞋子舒适度很重要。",
      },
    ],
  },
  {
    ...
    visaStay: { en: "Visa free entry · 30 days", zh: "免签入境 · 30 天" },
    flightTime: {
      en: "About 8 to 9 hours from major China gateways",
      zh: "中国主要口岸出发约 8 到 9 小时",
    },
    budget: { en: "RMB 9,000 to 18,000 for 4 to 5 days", zh: "4 到 5 天约人民币 9000 到 1.8 万" },
    bestFor: {
      en: "Short premium urban breaks and design-led stays",
      zh: "精致城市短假与设计感酒店体验",
    },
    tagline: {
    ...
    whyChineseTravelers: [
      {
        en: "Comfortable for premium stopovers, long weekends, or a calmer luxury trip than Dubai.",
        zh: "适合轻奢中转、长周末或比迪拜更安静一些的品质旅行。",
      },
      {
        en: "Museum and architecture lovers get a strong reward in a compact area.",
        zh: "喜欢博物馆和建筑的旅客能在紧凑城市尺度中获得很高回报。",
      },
      {
        en: "The city format suits travelers who prefer one base hotel and easy movement.",
        zh: "城市结构很适合以一家酒店为基地、轻松串联行程。",
      },
    ],
    topPlaces: [
      {
        en: "Msheireb Downtown for design-focused city wandering and cafés",
        zh: "姆希里布市中心：设计感街区与咖啡空间",
      },
      {
        en: "Museum of Islamic Art waterfront for skyline views and cultural depth",
        zh: "伊斯兰艺术博物馆海滨区：文化与天际线兼具",
      },
      {
        en: "Souq Waqif for evening atmosphere and a more local rhythm",
        zh: "瓦其夫老市场：夜晚氛围感更强，也更有在地气息",
      },
    ],
    bestTime: [
      {
        en: "November to March for outdoor comfort and waterfront evenings",
        zh: "11 月到次年 3 月：适合户外和海滨夜景",
      },
      {
        en: "December for event season and especially pleasant walking weather",
        zh: "12 月：活动多，步行舒适度更高",
      },
    ],
    practicalTips: [
      {
        en: "Pair museums with waterfront promenades to keep the pace balanced.",
        zh: "建议把博物馆和海边散步搭配安排，节奏会更舒服。",
      },
      {
        en: "Doha is easier when you stay central rather than splitting hotels.",
        zh: "住在市区核心位置通常比换酒店更省心。",
      },
      {
        en: "Keep one evening free for skyline dining or a slow corniche walk.",
        zh: "预留一个晚上给天际线餐厅或海滨长廊散步，会很值得。",
      },
    ],
  },
];
